...
const SearchComponent = ({selectedShip, visible, setCardVisible}) => {
    ...
    return (
        <>
        { visible === true ?
            <div className=' absolute w-72 left-0 top-16 z-[500] bg-white transition-all ease-in-out duration-700'>
